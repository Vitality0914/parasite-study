...
check(typingApp.includes('submittedAnswer:') && typingApp.includes('correctAnswer:') && typingApp.includes('buildCharacterDiff'), 'typing answer comparison missing');
check(typingApp.includes("comparison.distance <= 3") && typingApp.includes('스펠링 주의!'), 'typing spelling warning missing');
...
check(practiceApp.includes('submittedAnswer:') && practiceApp.includes('correctAnswer:') && practiceApp.includes('buildCharacterDiff'), 'typing practice answer comparison missing');
check(practiceApp.includes("comparison.distance <= 3") && practiceApp.includes('스펠링 주의!'), 'typing practice spelling warning missing');
